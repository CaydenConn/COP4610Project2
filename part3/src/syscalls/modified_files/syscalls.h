/* ~/test-kernel-work/include/linux/syscalls.h

 lines modified are toward the bottom:

    asmlinkage long sys_start_elevator(void);			            // declaring syscalls for kernel
    asmlinkage long sys_issue_request(int start_floor,              // to compile and link the table
                                    int destination_floor,          // entries 
                                    int type);
